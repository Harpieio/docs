  ...
  return (
    <div className="flex flex-col gap-20 px-8 mx-auto my-20 sm:flex-row max-w-screen-2xl lg:px-20 md:px-12">
      <Link
        ...
        className="flex-auto rounded-2xl p-8 text-lg md:text-xl border-2 border-solid border-[#251F2F] no-underline"
      >
      ...
      <Link
        ...
        className="flex-auto text-lg md:text-xl p-8 rounded-2xl border-2 border-solid border-[#251F2F] no-underline"
      >
        <p className="text-[#E9D4FF] font-normal max-w-56">
